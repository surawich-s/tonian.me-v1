            ...
            <div className="my-4 flex w-full flex-col items-center justify-center md:my-8 lg:my-12 md:gap-24">
                {projects.map((project: any) => {
                    ...
                    return (
                        <div
                            key={project.id}
                            className="relative flex h-auto flex-col justify-end items-center text-center my-4 md:h-80 rounded-lg p-4 text-white drop-shadow-md md:m-0  w-full md:w-1/2"
                        >
                            <div className="w-full h-48 z-0 overflow-hidden">
                                <Image
